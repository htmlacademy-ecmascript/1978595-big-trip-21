...
class EditorView extends View {
  ...
  createDestinationFieldHtml() {
    ...
    return html`
      ...
      <input class="event__input  event__input--destination" id="event-destination-1" type="text" name="event-destination" value="${destinations.find((destination) => destination.isSelected)?.name}" list="destination-list-1">
